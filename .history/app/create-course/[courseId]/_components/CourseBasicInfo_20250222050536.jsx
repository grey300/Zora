...
import { db } from "@/lib/db"; // Ensure your db is properly imported
import { eq } from "drizzle-orm";
import { CourseList } from "@/db/schema"; // Ensure correct path to schema
...
function CourseBasicInfo({ course, refreshData }) {
  ...
  const onFileSelected = async (event) => {
    ...
    try {
      ...
      setImageUrl(data.secure_url); // Store the URL for later use
    } catch (error) {
