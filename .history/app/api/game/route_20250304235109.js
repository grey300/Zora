import { z } from "zod";
import { getAuth } from "@clerk/nextjs/server"; // Import getAuth for session handling
import { NextResponse } from "next/server"; // Import NextResponse to handle HTTP responses
