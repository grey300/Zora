  ...
  useEffect(() => {
    ...
    const GetCourse = async () => {
      if (!courseId || !user?.primaryEmailAddress?.emailAddress) {
        console.error("Missing courseId or user information");
        return;
      }
    ...
    GetCourse();
  }, [courseId, user?.primaryEmailAddress?.emailAddress]); // Dependency array ensures it updates with courseId or user info
