...
function QuizCreation() {
  ...
  const onSubmit = async (input) => {
    ...
    try {
      ...
      const PROMPT =
        type === "mixed"
          ? `Generate a quiz with a mix of multiple-choice questions and fill-in-the-blank questions about ${topic}. The quiz should have ${amount} questions in total, with an equal or near-equal split of both types. Provide the quiz in JSON format.`
          : `Generate a ${type} quiz about ${topic}. The quiz should have ${amount} questions. Provide the quiz in JSON format.`;
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="flex justify-between">
                ...
                <Button
                  ...
                  type="button"
                >
                  <BookOpen className="w-4 h-4 mr-2" /> Fill Blanks
                </Button>
