...
function CreateCourse() {
  ...
  const SaveCourseLayoutInDb = async (CourseLayout) => {
    ...
    // Check if userName is available, if not fallback to a default or use user.id
    const userName = user?.fullName || user?.id || "Anonymous User"; // Fallback to 'Anonymous User' if fullName and user.id are unavailable
