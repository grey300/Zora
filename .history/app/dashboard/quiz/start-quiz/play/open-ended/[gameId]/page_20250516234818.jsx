...
import MCQ from "@/app/dashboard/quiz/start-quiz/_components/MCQ";
import OpenEnded from "@/app/dashboard/quiz/start-quiz/_components/OpenEnded";
export default async function OpenEndedPage({ params }) {
  ...
  if (gameData.gameType !== "open_ended") {
    console.log(
      `Game type mismatch: expected open_ended but got ${gameData.gameType}`
    );
    return redirect("/quiz");
  }
