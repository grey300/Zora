...
function QuizMeCard() {
  return (
    <Link
      ...
      className="group relative block overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-700 p-6 text-white transition-all hover:-translate-y-0.5 hover:shadow-lg"
    >
