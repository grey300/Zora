    ...
    <div className="border p-6 rounded-xl shadow-sm mt-3">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <div className="flex gap-2">
          <GiSkills className="text-4xl text-primary dark:text-[#6D7588]" />
          <div>
        ...
        <div className="flex gap-2">
          <GiDuration className="text-4xl text-primary  dark:text-[#6D7588]" />
          <div>
        ...
        <div className="flex gap-2">
          <RiSortNumberDesc className="text-4xl text-primary  dark:text-[#6D7588]" />
          <div>
        ...
        <div className="flex gap-2">
          <MdVideoSettings className="text-4xl text-primary  dark:text-[#6D7588]" />
          <div>
