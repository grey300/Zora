...
import { db } from "@/lib/db"; // Adjust path to your Drizzle instance
import { eq } from "drizzle-orm";
import { CourseList } from "@/db/schema"; // Adjust based on your schema file
...
function CourseBasicInfo({ course, refreshData }) {
  ...
  const onFileSelected = async (event) => {
    ...
    try {
      ...
      // ✅ Fix: Ensure db is defined before updating
      if (!db) {
