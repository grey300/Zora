...
function QuizCreation() {
  ...
  const topicParam = searchParams.get("topic") || ""; // ✅ Get topic from URL
  ...
  const form = useForm({
    ...
    defaultValues: {
      topic: topicParam, // ✅ Pre-fill Topic with URL topic if available
      type: "open_ended",
      amount: 3,
    },
  });
  ...
  useEffect(() => {
    if (topicParam) {
      form.setValue("topic", topicParam); // ✅ Update topic field if topicParam changes
    }
  }, [topicParam, form]);
