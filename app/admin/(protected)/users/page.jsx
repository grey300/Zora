      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-700 bg-gray-900 py-2 pl-9 pr-3 text-sm text-white outline-none focus:border-indigo-500"
          />
        </div>
      </div>
                  ...
                  <tr key={u.id} className="text-gray-200">
                    <td className="px-5 py-3">
                      <div className="font-medium text-white">
                        {u.name || "—"} {isSelf && <span className="text-xs text-indigo-400">(you)</span>}
                      </div>
